...
## [0.1.4](https://github.com/doublewordai/silt/compare/v0.1.3...v0.1.4) - 2025-12-12

### Other

- Make idempotency key optional with server-side generation

## [0.1.3](https://github.com/doublewordai/silt/compare/v0.1.2...v0.1.3) - 2025-12-12

### Other

- Add Cargo.lock for reproducible builds

## [0.1.2](https://github.com/doublewordai/silt/compare/v0.1.1...v0.1.2) - 2025-12-12

### Other

- Use PAT to allow workflow triggering
